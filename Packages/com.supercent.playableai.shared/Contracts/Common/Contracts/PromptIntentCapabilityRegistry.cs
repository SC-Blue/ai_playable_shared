...
namespace Supercent.PlayableAI.Common.Contracts
{
    ...
    public static class PromptIntentCapabilityRegistry
    {
        ...
        private static readonly PromptIntentTargetSurfaceRuleDescriptor[] TARGET_SURFACES =
        {
            ...
            new PromptIntentTargetSurfaceRuleDescriptor { role = PromptIntentObjectRoles.PHYSICS_AREA, summary = "Physics area surface", supportedEventKeys = new[] { FlowTargetEventKeys.ROOT, FlowTargetEventKeys.GET_ITEM } },
        };

        private static readonly PromptIntentGameplaySignalRuleDescriptor[] GAMEPLAY_SIGNALS =
        {
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.ITEM_GENERATED, summary = "Generator item generation signal", supportsTargetId = true, requiresTargetId = true, supportsItem = true, requiresItem = true, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.ITEM_COLLECTED, summary = "Item collection signal", supportsTargetId = true, requiresTargetId = true, supportsItem = true, requiresItem = true, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.RAIL_ITEM_ARRIVED, summary = "Rail arrival signal", supportsTargetId = true, requiresTargetId = true, supportsItem = true, requiresItem = true, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.ITEM_DELIVERED, summary = "Item delivery signal", supportsTargetId = false, requiresTargetId = false, supportsItem = true, requiresItem = true, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.ITEM_CONVERTED, summary = "Processing completion signal", supportsTargetId = true, requiresTargetId = true, supportsItem = true, requiresItem = true, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.SALE_COMPLETED, summary = "Sale completion signal", supportsTargetId = true, requiresTargetId = true, supportsItem = true, requiresItem = false, supportsCurrencyId = true, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.MONEY_COLLECTED, summary = "Money collection completion signal", supportsTargetId = false, requiresTargetId = false, supportsItem = false, requiresItem = false, supportsCurrencyId = true, requiresCurrencyId = true, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.CUSTOMER_SPAWN_STARTED, summary = "Customer spawn start signal", supportsTargetId = true, requiresTargetId = true, supportsItem = false, requiresItem = false, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
            new PromptIntentGameplaySignalRuleDescriptor { signalId = GameplaySignalIds.CUSTOMER_SERVED, summary = "Customer service completion signal", supportsTargetId = true, requiresTargetId = true, supportsItem = false, requiresItem = false, supportsCurrencyId = false, requiresCurrencyId = false, requiredTargetEventKey = string.Empty },
        };
        ...
        private static readonly PromptIntentConditionCapabilityDescriptor[] CONDITION_CAPABILITIES =
        {
            ...
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.ITEM_GENERATED, summary = "Generator generation signal", supportedTargetRoles = new[] { PromptIntentObjectRoles.GENERATOR }, allowAnyTargetRole = false, gameplaySignalId = GameplaySignalIds.ITEM_GENERATED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.ITEM_COLLECTED, summary = "Collection signal", supportedTargetRoles = new string[0], allowAnyTargetRole = true, gameplaySignalId = GameplaySignalIds.ITEM_COLLECTED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.ITEM_CONVERTED, summary = "Processing completion signal", supportedTargetRoles = new[] { PromptIntentObjectRoles.PROCESSOR }, allowAnyTargetRole = false, gameplaySignalId = GameplaySignalIds.ITEM_CONVERTED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.RAIL_ITEM_ARRIVED, summary = "Rail arrival signal", supportedTargetRoles = new string[0], allowAnyTargetRole = true, gameplaySignalId = GameplaySignalIds.RAIL_ITEM_ARRIVED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.SALE_COMPLETED, summary = "Sale completion signal", supportedTargetRoles = new[] { PromptIntentObjectRoles.SELLER }, allowAnyTargetRole = false, gameplaySignalId = GameplaySignalIds.SALE_COMPLETED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.MONEY_COLLECTED, summary = "Money collection completion signal", supportedTargetRoles = new string[0], allowAnyTargetRole = false, gameplaySignalId = GameplaySignalIds.MONEY_COLLECTED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
            new PromptIntentConditionCapabilityDescriptor { kind = PromptIntentConditionKinds.CUSTOMER_SERVED, summary = "Seller customer service completion signal", supportedTargetRoles = new[] { PromptIntentObjectRoles.SELLER }, allowAnyTargetRole = false, gameplaySignalId = GameplaySignalIds.CUSTOMER_SERVED, stepConditionType = StepConditionRules.GAMEPLAY_SIGNAL, reactiveConditionType = StepConditionRules.GAMEPLAY_SIGNAL },
        };
