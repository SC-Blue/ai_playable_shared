...
namespace Supercent.PlayableAI.Common.Contracts
{
    ...
    public static class PromptIntentCapabilityRegistry
    {
        ...
        private static readonly PromptIntentEffectCapabilityDescriptor[] EFFECT_CAPABILITIES =
        {
            ...
            new PromptIntentEffectCapabilityDescriptor { kind = PromptIntentEffectKinds.SHOW_ARROW, summary = "show arrow system action mapping", supportedTargetRoles = new string[0], allowAnyTargetRole = true, systemActionId = SystemActionIds.SHOW_ARROW_ON_TARGET, runtimeEventKey = FlowTargetEventKeys.ROOT, buildsSceneActivationTarget = false, buildsSystemActionTarget = false },
