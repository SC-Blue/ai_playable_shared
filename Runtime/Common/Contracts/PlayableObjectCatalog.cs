...
namespace Supercent.PlayableAI.Common.Contracts
{
    ...
    public sealed class PlayableObjectCatalog : ScriptableObject
    {
        ...
        [SerializeField] private FeatureDescriptor[] _featureDescriptors = new FeatureDescriptor[0];
        ...
        public bool IsSupportedFeatureType(string featureType)
        {
            ...
            FeatureDescriptor[] safeDescriptors = _featureDescriptors ?? new FeatureDescriptor[0];
