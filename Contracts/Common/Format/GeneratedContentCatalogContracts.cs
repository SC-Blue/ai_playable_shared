...
namespace Supercent.PlayableAI.Common.Format
{
    ...
    public sealed class GeneratedContentCatalogDocument
    {
        ...
        public string[] availableFeatureTypes = new string[0];
        public FeatureDescriptor[] featureDescriptors = new FeatureDescriptor[0];
        public GeneratedContentCatalogThemeCatalog[] themeCatalogs = new GeneratedContentCatalogThemeCatalog[0];
    }
    ...
    public sealed class GeneratedContentCatalogThemeCatalog
    {
        ...
        public GeneratedContentCatalogThemeOption[] availableThemes = new GeneratedContentCatalogThemeOption[0];
        public string[] availableFeatureTypes = new string[0];
        public FeatureDescriptor[] featureDescriptors = new FeatureDescriptor[0];
    ...
    public sealed class GeneratedContentCatalogStep2Document
    {
        ...
        public GeneratedContentCatalogGameplayObject[] objects = new GeneratedContentCatalogGameplayObject[0];
        public GeneratedContentCatalogSelectableContent[] contents = new GeneratedContentCatalogSelectableContent[0];
    }
    ...
    public sealed class GeneratedContentCatalogStep3Document
    {
        ...
        public string selectableUiRootPath = string.Empty;
        public string selectionInstructions = string.Empty;
        public GeneratedContentCatalogGameplayObject[] gameplayObjects = new GeneratedContentCatalogGameplayObject[0];
        public GeneratedContentCatalogSelectableContent[] contents = new GeneratedContentCatalogSelectableContent[0];
        public GeneratedContentCatalogEnvironmentObject[] environmentObjects = new GeneratedContentCatalogEnvironmentObject[0];
    }
    ...
    public sealed class GeneratedContentCatalogGameplayObject
    {
        ...
        public GeneratedContentCatalogGameplayDesign[] designs = new GeneratedContentCatalogGameplayDesign[0];
    }
    ...
    public sealed class GeneratedContentCatalogSelectableContent
    {
        ...
        public GeneratedContentCatalogSelectableContentDesign[] designs = new GeneratedContentCatalogSelectableContentDesign[0];
    }
    ...
    public sealed class GeneratedContentCatalogEnvironmentObject
    {
        ...
        public GeneratedContentCatalogEnvironmentDesign[] designs = new GeneratedContentCatalogEnvironmentDesign[0];
    }
    ...
    public sealed class GeneratedContentCatalogEnvironmentDesign
    {
        ...
        public string description = string.Empty;
        public GeneratedContentCatalogFootprint footprint = null;
        public string[] perimeterShape = new string[0];
    }
