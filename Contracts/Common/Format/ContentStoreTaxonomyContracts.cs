...
namespace Supercent.PlayableAI.Common.Format
{
    ...
    public sealed class ContentStoreTaxonomyDefinition
    {
        ...
        public ContentStoreTaxonomyOption[] themes = new ContentStoreTaxonomyOption[0];
        public ContentStoreTaxonomyOption[] contentKinds = new ContentStoreTaxonomyOption[0];
        public ContentStoreTaxonomyOption[] builtInGroups = new ContentStoreTaxonomyOption[0];
        public ContentStoreTaxonomyOption[] featureGroups = new ContentStoreTaxonomyOption[0];
        public ContentStoreTaxonomyOption[] sharedAssetGroups = new ContentStoreTaxonomyOption[0];
        public ContentStoreTaxonomySubcategoryGroup[] builtInSubcategoryGroups = new ContentStoreTaxonomySubcategoryGroup[0];
    }
    ...
    public sealed class ContentStoreTaxonomySubcategoryGroup
    {
        ...
        public ContentStoreTaxonomyOption[] subcategories = new ContentStoreTaxonomyOption[0];
    }
    ...
    public static class ContentStoreTaxonomyRules
    {
        ...
        public static bool IsSharedCategory(string category)
        {
            ...
            return SharedAssetGroupOptions.Any(option =>
                ...
                (option.aliases ?? new string[0]).Any(alias => string.Equals(alias, normalized, StringComparison.Ordinal)));
        }
        ...
        public static string CanonicalizeThemeId(string themeId)
        {
            ...
            ContentStoreTaxonomyOption option = ThemeOptions.FirstOrDefault(candidate =>
                ...
                (candidate.aliases ?? new string[0]).Any(alias => string.Equals(alias, normalized, StringComparison.Ordinal)));
        ...
        private static ContentStoreTaxonomySubcategoryGroup Group(string category, params ContentStoreTaxonomyOption[] subcategories)
        {
            ...
            {
                category = category,
                subcategories = subcategories ?? new ContentStoreTaxonomyOption[0],
            };
        }
        ...
        private static ContentStoreTaxonomyOption CloneOption(ContentStoreTaxonomyOption source)
        {
            return new ContentStoreTaxonomyOption
            {
                ...
                aliases = (source.aliases ?? new string[0]).ToArray(),
            };
        }
        ...
        private static ContentStoreTaxonomySubcategoryGroup CloneGroup(ContentStoreTaxonomySubcategoryGroup source)
        {
            return new ContentStoreTaxonomySubcategoryGroup
            {
                ...
                subcategories = CloneOptions(source.subcategories ?? new ContentStoreTaxonomyOption[0]),
            };
        }
