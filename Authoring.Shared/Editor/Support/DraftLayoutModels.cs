...
namespace PlayableAI.AuthoringCore
{
    ...
    public sealed class DraftLayoutDocument
    {
        ...
        public DraftLayoutPlacementEntry[] placements = new DraftLayoutPlacementEntry[0];
        public DraftLayoutPlayerStartEntry playerStart = new DraftLayoutPlayerStartEntry();
        public DraftLayoutEnvironmentEntry[] environment = new DraftLayoutEnvironmentEntry[0];
        public DraftLayoutCustomerPathEntry[] customerPaths = new DraftLayoutCustomerPathEntry[0];
    }
    ...
    public sealed class DraftLayoutCustomerPathEntry
    {
        ...
        public DraftLayoutCustomerPathPoint[] queuePoints = new DraftLayoutCustomerPathPoint[0];
        public DraftLayoutCustomerPathPoint[] entryWaypoints = new DraftLayoutCustomerPathPoint[0];
        public DraftLayoutCustomerPathPoint[] exitWaypoints = new DraftLayoutCustomerPathPoint[0];
    }
}
