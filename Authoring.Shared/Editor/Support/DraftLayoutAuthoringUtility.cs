...
namespace PlayableAI.AuthoringCore
{
    public static class DraftLayoutAuthoringUtility
    {
            ...
            PlayableObjectCatalog catalog)
        {
            ...
            DraftLayoutPlacementEntry[] draftPlacements = draftLayout != null ? draftLayout.placements ?? new DraftLayoutPlacementEntry[0] : new DraftLayoutPlacementEntry[0];
            ...
            DraftLayoutEnvironmentEntry[] draftEnvironment = draftLayout != null ? draftLayout.environment ?? new DraftLayoutEnvironmentEntry[0] : new DraftLayoutEnvironmentEntry[0];
            ...
            DraftLayoutCustomerPathEntry[] draftCustomerPaths = draftLayout != null ? draftLayout.customerPaths ?? new DraftLayoutCustomerPathEntry[0] : new DraftLayoutCustomerPathEntry[0];
            ...
            return new LayoutSpecDocument
            {
                ...
                sourceImages = new LayoutSpecSourceImageEntry[0],
            };
        }
        ...
        {
            source ??= new DraftLayoutCustomerPathPoint[0];
